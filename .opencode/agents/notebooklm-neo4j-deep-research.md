---
description: Iterative topic expansion and deep research across a NotebookLM notebook and a Neo4j graph built from the same source corpus. Use this subagent when you need to answer or explore a topic by alternating between NotebookLM notebook queries and Neo4j concept-neighborhood queries.
mode: subagent
---
...
```text
Use the notebooklm-neo4j-deep-research subagent with NotebookLM notebook "quant-rnd" and the matching Neo4j graph.
